...
<template>
    ...
    <div class="flex h-full flex-1 flex-col gap-4 p-4">
        <div class="max-w-2xl mx-auto w-full bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
            <h2 class="text-xl font-bold mb-6 text-gray-800 dark:text-gray-200">Edit User: {{ user.name }}</h2>
            ...
            <form @submit.prevent="submit">
                ...
                <div class="flex justify-end gap-3 mt-6">
                    <Link href="/users" class="px-4 py-2 text-gray-600 dark:text-gray-400 hover:text-gray-900">Batal</Link>
